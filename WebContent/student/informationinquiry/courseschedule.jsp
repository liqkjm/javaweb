<%@page import="com.software.entity.CourseScheduleShow"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.HashMap"%>
<%@page import="com.software.entity.CourseSchedule"%>
...
<body style="background:url(../informationinquiry/back2.jpg) no-repeat;">
