<%@page import="com.software.entity.StudentBasicInformation"%>
<%@page import="com.software.entity.LevelExamination"%>
...
<body>
	...
	<br><br>
	<a href="<%=request.getContextPath() %>/student/informationinquiry/grade.jsp">返回上一步</a>
	<div>
		<h3>考级成绩</h3>
	</div>
